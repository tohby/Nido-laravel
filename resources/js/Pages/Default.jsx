                ...
                <div className="max-w-[80rem] mx-auto">
                    <div className="mb-[40px]">
                        <div className="grid grid-cols-2 gap-10">
                            <div>
                                <div className="w-full h-1 max-w-28 min-h-1 bg-green-700 mb-4"></div>
                                <h2 className="text-5xl mb-0">
                                    Welcome to Nido Vietnam, your home base in
                                    the diaspora.
                                </h2>
                            </div>
                            <div className="self-end justify-self-end">
                                <p className="mb-0 text-lg">
                                    Experience the power of community as
                                    Nigerians come together in Vietnam to
                                    support, inspire, and uplift each other.
                                    Nido is your anchor in a world of
                                    opportunities.
                                </p>
                            </div>
                        </div>
                                ...
                                <ul className="flex flex-col gap-6">
                                    <li>
                                        ...
                                        <p className="body-s pr-4 md:pr-0 lg:pb-4">
                                            ...
                                            available, empathetic, and aligned
                                    ...
                                    <li>
                                        ...
                                        <p className="body-s pr-4 md:pr-0 lg:pb-4">
                                            ...
                                            reporting to continuously improve
                                            the customer experience.{" "}
                                        </p>
                                    </li>
                                </ul>
                            </div>
                            <div className="col-span-12 mb-6 md:col-span-6 md:mb-0 lg:col-span-3x lg:col-start-7">
                                <div className="relative aspect-square overflow-hidden rounded-2xl bg-gray-200 theme-tech:bg-gray-700 theme-platform:bg-gray-100 lg:rounded-3xl">
                                    <img
                                        alt="Nigerian fulani couple "
                                        loading="lazy"
                                        decoding="async"
                                        data-nimg="fill"
                                        className="block h-5/6 w-full object-cover"
                                        style={{
                                            position: "absolute",
                                            height: "100%",
                                            width: "100%",
